...
- The live inspection form is your worksheet. Call list_checklist_items ONCE early to load the exact line-item labels (sections: Hot Tub, Kitchen, Bathrooms, Bedroom, Home, Outdoors, Utilities, Gifts). Every item holds one narrative note and up to three photos: one "before", one "after", and "evidence" (the default).
